                ...
                <div class="col-lg-12">
                    <form id="add_fileprefix" class="form-horizontal" name="add_fileprefix">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="Penerangan" type="text" value="{{$prefix->description}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select id="is_active" class="form-control">
                                    ...
                                    <option value="1" {{($prefix->is_active == 1 ? " selected" : "")}}>Aktif</option>
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Kemaskini Awalan Fail COB berjaya!</span>", function () {
