        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button onclick="window.location = '{{ URL::action('SettingController@addDesignation') }}'" type="button" class="btn btn-primary">
                        Add Designation
                    </button>
                    <br/><br/>
                    <?php } ?>
...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#designation').DataTable({
            "sAjaxSource": "{{URL::action('SettingController@getDesignation')}}",
    ...
    function inactiveDesignation(id) {
        $.ajax({
            url: "{{ URL::action('SettingController@inactiveDesignation') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function activeDesignation(id) {
        $.ajax({
            url: "{{ URL::action('SettingController@activeDesignation') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function deleteDesignation (id) {
        ...
        function(){
            $.ajax({
                url: "{{ URL::action('SettingController@deleteDesignation') }}",
                type: "POST",
                data: {
                    id: id
                },
