        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button onclick="window.location = '{{ URL::action('SettingController@addMemoType') }}'" type="button" class="btn btn-primary">
                        Add Memo Type
                    </button>
                    <br/><br/>
                    <?php } ?>
                    <table class="table table-hover nowrap" id="memotype" width="100%">
                        <thead>
                            <tr>
                                <th style="width:70%;">Memo Type</th>
...
<script>
    ...
    function inactiveMemoType(id) {
        $.ajax({
            url: "{{ URL::action('SettingController@inactiveMemoType') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function activeMemoType(id) {
        $.ajax({
            url: "{{ URL::action('SettingController@activeMemoType') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function deleteMemoType (id) {
        ...
        function(){
            $.ajax({
                url: "{{ URL::action('SettingController@deleteMemoType') }}",
                type: "POST",
                data: {
                    id: id
                },
