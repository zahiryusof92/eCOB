                ...
                <div class="col-lg-12">
                    <form id="add_memo_type" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="Unit of Measure" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addUnitMeasure()">Save</button>
                            <?php } ?>
                            <button type="button" class="btn btn-default" id="cancel_button" onclick="window.location ='{{ URL::action("SettingController@unitMeasure") }}'">Cancel</button>
                        </div>
                    </form>
                </div>                
            </div>
...
<script>
    ...
    function addUnitMeasure() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('SettingController@submitUnitMeasure') }}",
                type: "POST",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Unit of Measure added successfully!</span>", function () {
                            window.location = '{{URL::action("SettingController@unitMeasure") }}';
                        });
                    } else {
