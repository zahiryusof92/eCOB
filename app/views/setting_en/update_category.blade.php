                ...
                <div class="col-lg-12">
                    <form id="update_category" class="form-horizontal">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="updateCategory()">Save</button>
                            <?php } ?>
...
<script>
    ...
    function updateCategory() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('SettingController@submitUpdateCategory') }}",
                type: "POST",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Category updated successfully!</span>", function () {
