        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button onclick="window.location = '{{ URL::action('SettingController@addState') }}'" type="button" class="btn btn-primary">
                        Add State
                    </button>
                    <br/><br/>
                    <?php } ?>
...
<script>
    ...
    function inactiveState(id) {
        $.ajax({
            url: "{{ URL::action('SettingController@inactiveState') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function activeState(id) {
        $.ajax({
            url: "{{ URL::action('SettingController@activeState') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function deleteState (id) {
        ...
        function(){
            $.ajax({
                url: "{{ URL::action('SettingController@deleteState') }}",
                type: "POST",
                data: {
                    id: id
                },
