                ...
                <div class="col-lg-12">
                    <form id="form_country" class="form-horizontal" name="add_fileprefix">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="name" class="form-control" placeholder="Country" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="submitCountry()">Save</button>
                            <?php } ?>
...
<script>
    function submitCountry() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('SettingController@submitCountry') }}",
                type: "POST",
                data: {
                    name: name,
                    sort_no : sort_no,
