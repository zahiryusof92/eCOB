                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name" id="name" value="{{ $ajk_details->name }}"/>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Phone Number" id="phone_no" value="{{ $ajk_details->phone_no }}"/>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Year" id="year" value="{{ $ajk_details->year }}"/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Remarks" id="remarks" rows="5">{{ $ajk_details->remarks }}</textarea>
                                </div>                    
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <?php if ($update_permission == 1) { ?>
                                <button type="button" class="btn btn-primary" id="submit_button" onclick="editAJKDetail()">Submit</button>
                            <?php } ?>
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>AJK updated successfully!</span>", function () {
