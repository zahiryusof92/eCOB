            ...
            <div class="invoice-block">
                ...
                <div class="row text-center">
                    <div class="col-lg-12">
                        ...
                        <input style="font-size: 12px;" id="date_from" type="text" class="form-control width-150 display-inline-block" value="{{date('Y/m/d', strtotime('now'))}}" placeholder="From"/>
                        <span style="font-size: 12px;" class="margin-right-10">—</span>
                        <input style="font-size: 12px;" id="date_to" type="text" class="form-control width-150 display-inline-block" placeholder="To"/>
                        <button style="font-size: 12px;" type="button" class="form-control btn btn-primary width-100 display-inline-block" id="submit_button">Search</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table class="table" id="audit_trail" width="100%" style="font-size: 12px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:40%; text-align: center !important;">Activities</th>
                                    <th style="width:20%; text-align: center !important;">Action From</th>
                                    <th style="width:20%; text-align: center !important;">Action Date</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
