                ...
                <table class="table table-sm" id="dynamic_form_admin" style="font-size: 12px;">
                    ...
                    <tbody>
                        ...
                        <tr id="admin_row{{ ++$count }}">
                            ...
                            <td><input type="text" oninput="calculateAdmin('{{ $count }}')" id="{{ $prefix . 'tunggakan_' . $count }}" name="{{ $prefix }}tunggakan[]" class="form-control form-control-sm text-right numeric-only" value="{{ $adminFiles['tunggakan'] }}"></td>
                            <td><input type="text" oninput="calculateAdmin('{{ $count }}')" id="{{ $prefix . 'semasa_' . $count }}" name="{{ $prefix }}semasa[]" class="form-control form-control-sm text-right numeric-only" value="{{ $adminFiles['semasa'] }}"></td>
                            <td><input type="text" oninput="calculateAdmin('{{ $count }}')" id="{{ $prefix . 'hadapan_' . $count }}" name="{{ $prefix }}hadapan[]" class="form-control form-control-sm text-right numeric-only" value="{{ $adminFiles['hadapan'] }}"></td>
                            ...
                            <td><input type="text" oninput="calculateAdminTotal('{{ $count }}')" id="{{ $prefix . 'tertunggak_' . $count }}" name="{{ $prefix }}tertunggak[]" class="form-control form-control-sm text-right numeric-only" value="{{ $adminFiles['tertunggak'] }}"></td>
