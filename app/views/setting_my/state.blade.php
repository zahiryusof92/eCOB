        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button onclick="window.location = '{{ URL::action('AdminController@addState') }}'" type="button" class="btn btn-primary">
                        Add State
                    </button>
                    <br/><br/>
                    <?php } ?>
...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#state').DataTable({
            "sAjaxSource": "{{URL::action('AdminController@getState')}}",
    ...
    function inactiveState(id) {
        $.ajax({
            url: "{{ URL::action('AdminController@inactiveState') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function activeState(id) {
        $.ajax({
            url: "{{ URL::action('AdminController@activeState') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function deleteState (id) {
        ...
        function(){
            $.ajax({
                url: "{{ URL::action('AdminController@deleteState') }}",
                type: "POST",
                data: {
                    id: id
                },
