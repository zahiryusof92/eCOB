                ...
                <div class="col-lg-12">
                    <form id="form_country" class="form-horizontal" name="add_fileprefix">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="name" class="form-control" placeholder="{{ trans('app.forms.country') }}" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="submitCountry()">{{ trans('app.forms.save') }}</button>
                            <?php } ?>
...
<script>
    function submitCountry() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AdminController@submitCountry') }}",
                type: "POST",
                data: {
                    name: name,
                    sort_no : sort_no,
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Country added successfully!</span>", function () {
