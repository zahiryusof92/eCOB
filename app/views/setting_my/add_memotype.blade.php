                ...
                <div class="col-lg-12">
                    <form id="add_memo_type" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="Jenis Memo" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addMemoType()">Simpan</button>
                            <?php } ?>
...
<script>
    ...
    function addMemoType() {
        ...
        if (is_active.trim() == "") {
            $("#is_active_error").html('<span style="color:red;font-style:italic;font-size:13px;">Sila masukkan Status</span>');
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AdminController@submitMemoType') }}",
                type: "POST",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Jenis Memo berjaya ditambah!</span>", function () {
