                ...
                <div class="col-lg-12">
                    <form id="add_land" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="Jenis Tanah" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addLandTitle()">Simpan</button>
                            <?php } ?>
...
<script>
    ...
    function addLandTitle() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AdminController@submitLandTitle') }}",
                type: "POST",
                data: {
