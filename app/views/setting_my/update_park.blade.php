                ...
                <div class="col-lg-12">
                    <form id="add_fileprefix" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="Taman" type="text" value="{{$park->description}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select id="is_active" class="form-control">
                                    <option value="">Sila pilih</option>
                                    <option value="1" {{($park->is_active==1 ? " selected" : "")}}>Aktif</option>
                                    <option value="0" {{($park->is_active==0 ? " selected" : "")}}>Tidak Aktif</option>
                                </select>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="updatePark()">Simpan</button>
                            <?php } ?>
...
<script>    
    function updatePark() {
        ...
        if (dun.trim() == "") {
            $("#parliament_error").html('<span style="color:red;font-style:italic;font-size:13px;">Sila pilih DUN</span>');
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AdminController@submitUpdatePark') }}",
                type: "POST",
                data: {
                    dun: dun,
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Taman berjaya dikemaskini!</span>", function () {
