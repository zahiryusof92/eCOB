                ...
                <div class="col-lg-12">
                    ...
                    <form id="add_user">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><span style="color: red;">*</span> A{{ trans('app.forms.access_group') }}</label>
                        ...
                        <div class="form-actions">
                            <?php if ($insert_permission == 1) { ?>
                                <button type="button" class="btn btn-primary" id="submit_button" onclick="addUser()">{{ trans('app.forms.submit') }}</button>
                            <?php } ?>
