                    ...
                    <form id="ratingSubmit" class="form-horizontal">
                        ...
                        <div class="form-actions">
                            <?php if ($insert_permission == 1) { ?>
                                <button type="button" class="btn btn-primary" id="submit_button" onclick="submitAddRating()">{{ trans('app.forms.submit') }}</button>
                            <?php } ?>
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Rating added successfully!</span>", function () {
