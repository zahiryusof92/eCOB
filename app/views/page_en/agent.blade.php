        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button onclick="window.location = '{{ URL::action('AdminController@addAgent') }}'" type="button" class="btn btn-primary">
                        Add Agent
                    </button>
                    <br/><br/>
                    <?php } ?>
...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#land').DataTable({
            "sAjaxSource": "{{URL::action('AdminController@getAgent')}}",
    ...
    function inactiveAgent(id) {
        $.ajax({
            url: "{{ URL::action('AdminController@inactiveAgent') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function activeAgent(id) {
        $.ajax({
            url: "{{ URL::action('AdminController@activeAgent') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function deleteAgent(id) {
        ...
        function(){
            $.ajax({
                url: "{{ URL::action('AdminController@deleteAgent') }}",
                type: "POST",
                data: {
                    id: id
                },
