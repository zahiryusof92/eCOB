                ...
                <div class="col-lg-12">
                    <form id="add_fileprefix" class="form-horizontal" name="add_fileprefix">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="Parliment" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addParliment()">Save</button>
                            <?php } ?>
                            <button type="button" class="btn btn-default" id="cancel_button" onclick="window.location ='{{ URL::action("AdminController@parliment") }}'">Cancel</button>
                        </div>
                    </form>
                </div>                
            </div>
...
<script>
    ...
    function addParliment() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AdminController@submitParliment') }}",
                type: "POST",
                data: {
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Parliment added successfully!</span>", function () {
