                ...
                <div class="col-lg-12">
                    ...
                    <form id="add_developer">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addDeveloper()">Submit</button>
                            <?php } ?>
                            <button type="button" class="btn btn-default" id="cancel_button" onclick="window.location ='{{URL::action('AdminController@developer')}}'">Cancel</button>
                        </div>
                    </form>
                    <!-- End Vertical Form -->
                </div>                
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Developer added successfully!</span>", function () {
