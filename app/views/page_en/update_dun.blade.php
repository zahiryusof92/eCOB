                ...
                <div class="col-lg-12">
                    <form id="add_fileprefix" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select id="is_active" class="form-control">
                                    <option value="">Please Select</option>
                                    <option value="1" {{($dun->is_active==1 ? " selected" : "")}}>Active</option>
                                    <option value="0" {{($dun->is_active==0 ? " selected" : "")}}>Inactive</option>
                                </select>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="updateDun()">Save</button>
                            <?php } ?>
                            <button type="button" class="btn btn-default" id="cancel_button" onclick="window.location ='{{ URL::action("AdminController@dun") }}'">Cancel</button>
                        </div>
                    </form>
                </div>                
            </div>
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>DUN updated successfully!</span>", function () {
