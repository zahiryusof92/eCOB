                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="file_id" class="form-control">
                                        ...
                                        <option value="{{$files->id}}" 
                                            <?php if($financesupportdata->file_id == $files->id) {
                                                echo 'selected';
                                            }
                                            ?>
                                            >{{$files->file_no}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="mirror_date" id="mirror_date" value="{{ $financesupportdata->date }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="remark" id="remark" class="form-control">{{ $financesupportdata->remark }}</textarea>
...
<script>
    ...
    function submitFinanceSupport() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AdminController@updateFinanceSupport') }}",
                type: "POST",
                data: {
                    id : id,
                    file_id: file_no,
