            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="formSubmit" class="form-horizontal">
                        <input type="hidden" value="{{ $agmDesignSub->id }}" name="id">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="form_type" class="form-control" name="file_id">
                                        ...
                                        @foreach ($file as $f)
                                        <option value="{{$f->id}}" 
                                        <?php if($agmDesignSub->file_id === $f->id) echo 'selected'; ?>
                                        >{{$f->file_no}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="design_id" class="form-control" name="design_id">
                                        ...
                                        @foreach ($design as $f)
                                        <option value="{{$f->id}}"
                                            <?php if($agmDesignSub->design_id === $f->id) echo 'selected'; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" name="name" class="form-control" type="text" value="{{ $agmDesignSub->name }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" name="phone_number" class="form-control" type="text" value="{{ $agmDesignSub->phone_number }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" class="form-control" name="email" type="text" value="{{ $agmDesignSub->email }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ajk_year" class="form-control" name="ajk_year" type="text" value="{{ $agmDesignSub->ajk_year }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="remark" id="remark" cols="30" rows="10" class="form-control">{{ $agmDesignSub->remark }}</textarea>
...
<script>
    $("#formSubmit").submit(function(e){
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AgmController@submitUpdateAgmDesignSub') }}",
                type: "POST",
                data: $(this).serialize(),
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>AGM Submission Updated successfully!</span>", function () {
