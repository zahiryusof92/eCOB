                ...
                <div class="col-lg-12">
                    <form id="formSubmit" class="form-horizontal">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="form_type" class="form-control" name="form_type_id">
                                        ...
                                        <option value="{{$ft->id}}">{{$ft->bi_type}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bi_name" name="bi_name" class="form-control" type="text">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bm_name" name="bm_name" class="form-control" type="text">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="seq" class="form-control" name="seq" type="text">
...
<script>
    $("#formSubmit").submit(function(e){
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AdminController@submitForm') }}",
                type: "POST",
                data: $(this).serialize(),
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Form Added successfully!</span>", function () {
