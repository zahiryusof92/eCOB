            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="formSubmit" class="form-horizontal">
                        <input type="hidden" value="{{ $agmPurchaseSub->id }}" name="id">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="form_type" class="form-control" name="file_id">
                                        ...
                                        @foreach ($file as $f)
                                        <option value="{{$f->id}}" 
                                        <?php if($agmPurchaseSub->file_id === $f->id) echo 'selected'; ?>
                                        >{{$f->file_no}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="{{ $field }}" name="{{ $field }}" class="form-control" type="text" value="{{ $agmPurchaseSub->$field }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="remark" id="remark" cols="30" rows="10" class="form-control">{{ $agmPurchaseSub->remark }}</textarea>
...
<script>
    $("#formSubmit").submit(function(e){
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AgmController@submitUpdateAgmPurchaseSub') }}",
                type: "POST",
                data: $(this).serialize(),
