                ...
                <div class="col-lg-12">
                    ...
                    <div id="update_files_lists">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{URL::action('AdminController@others', $file->id)}}">Pelbagai</a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Nama</label>
                                                        <input type="text" class="form-control" placeholder="Nama" id="other_details_name" value="{{$other_details->name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <div id="others_image_output">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Padam" onclick="deleteImageOthers('{{$other_details->id}}')"><i class="fa fa-times"></i></button>
                                                            <?php } ?>
                                                        </div>
                                        ...
                                        <form id="others">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Latitud</label>
                                                        <input type="text" class="form-control" placeholder="Latitud" id="latitude">
                                                    </div>
                                                </div>
                                            </div>
                                            @else
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Latitud</label>
                                                        <input type="text" class="form-control" placeholder="Latitud" id="latitude" value="{{$other_details->latitude}}">
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Longitud" id="longitude">
                                                    </div>
                                                </div>
                                            </div>
                                            @else
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Longitud</label>
                                                        <input type="text" class="form-control" placeholder="Longitud" id="longitude" value="{{$other_details->longitude}}">
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="3" id="other_details_description" placeholder="Penerangan">{{$other_details->description}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <?php if ($update_permission == 1) { ?>
                                                <button type="button" class="btn btn-primary" id="submit_button" onclick="updateOtherDetails()">Simpan</button>
                                                <?php } ?>
