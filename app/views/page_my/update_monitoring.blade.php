                ...
                <div class="col-lg-12">
                    ...
                    <div id="update_files_lists">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{URL::action('AdminController@monitoring', $file->id)}}">Pemantauan</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="tab-pane active" id="monitoring" role="tabpanel">                                
                                <form id="monitoring">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" placeholder="No. Siri Sijil" id="certificate_series_no" value="{{$monitoring->certificate_no}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <textarea class="form-control" rows="3" placeholder="Catatan" id="monitoring_remarks">{{$monitoring->remarks}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <?php if ($update_permission == 1) { ?>
                                        <button type="button" class="btn btn-primary" id="submit_button" onclick="updateMonitoring()">Simpan</button>
                                        <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Tarikh AGM</label>
                        </div>
                        <div class="col-md-4">
                            <label class="input-group datepicker-only-init">
                                <input type="text" class="form-control" placeholder="Tarikh AGM" id="agm_date"/>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Mesyuarat Agung Tahunan (AGM)</label>
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="agm" name="agm" value="1"> Ada
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="agm" name="agm" value="0"> Tiada
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Mesyuarat Agung Luarbiasa (EGM)</label>
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="egm" name="egm" value="1"> Ada
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="egm" name="egm" value="0"> Tiada
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Minit Mesyuarat</label>
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="minit_meeting" name="minit_meeting" value="1"> Ada
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="minit_meeting" name="minit_meeting" value="0"> Tiada
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Salinan Perjanjian Jualbeli JMC</label>
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="jmc_copy" name="jmc_copy" value="1"> Ada
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="jmc_copy" name="jmc_copy" value="0"> Tiada
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Salinan Kad Pengenalan</label>
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="ic_list" name="ic_list" value="1"> Ada
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="ic_list" name="ic_list" value="0"> Tiada
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Senarai Kehadiran</label>
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="attendance_list" name="attendance_list" value="1"> Ada
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="attendance_list" name="attendance_list" value="0"> Tiada
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Laporan Kew Teraudit</label>
                        </div>
                        <div class="col-md-2">
                            <input type="radio" id="audited_financial_report" name="audited_financial_report" value="1"> Ada
                        </div>
                        <div class="col-md-2">
                ...
                <form>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Tarikh Mula Kewangan Audit</label>
                        </div>
                        <div class="col-md-4">
                            <label class="input-group datepicker-only-init">
                                <input type="text" class="form-control" placeholder="Tarikh Mula Kewangan Audit" id="audit_start"/>
                                <span class="input-group-addon">
                                    <i class="icmn-calendar"></i>
                                </span>
                            </label>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="form-control-label">Tarikh Akhir Kewangan Audit</label>
                        </div>
                        <div class="col-md-4">
                            <label class="input-group datepicker-only-init">
                                <input type="text" class="form-control" placeholder="Tarikh Akhir Kewangan Audit" id="audit_end"/>
                                <span class="input-group-addon">
                                    <i class="icmn-calendar"></i>
                                </span>
                            </label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Kemaskini Maklumat AGM</h4>
            </div>
            <div class="modal-body">
                <form>
                    <div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="input-group datepicker-only-init">
                                    <input type="text" class="form-control" placeholder="Tarikh AGM" id="agm_date_edit"/>
                                    <span class="input-group-addon">
                                        <i class="icmn-calendar"></i>
                                    </span>
                                </label>
                ...
                <form>
                    <div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="input-group datepicker-only-init">
                                    <input type="text" class="form-control" placeholder="Tarikh Mula Kewangan Audit" id="audit_start_edit"/>
                                    <span class="input-group-addon">
                                        <i class="icmn-calendar"></i>
                                    </span>
                                </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="input-group datepicker-only-init">
                                    <input type="text" class="form-control" placeholder="Tarikh Akhir Kewangan Audit" id="audit_end_edit"/>
                                    <span class="input-group-addon">
                                        <i class="icmn-calendar"></i>
                                    </span>
                                </label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Tambah Maklumat AJK</h4>
            </div>
            <form id="add_ajk">
                <div class="modal-body">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            <label class="form-control-label"><span style="color: red; font-style: italic;">*</span> Jawatan</label>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            <label class="form-control-label"><span style="color: red; font-style: italic;">*</span> Nama</label>
                        </div>
                        <div class="col-md-8">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Kemaskini Maklumat AJK</h4>
            </div>
            <form id="edit_ajk">
                <div class="modal-body">
                    <div class="form-group row">
...
<script>
    ...
    function addAJKDetail() {
        ...
        if (ajk_designation.trim() == "") {
            $("#ajk_designation_error").html('<span style="color:red;font-style:italic;font-size:13px;">Sila pilih Jawatan</span>');
    ...
    function editAJK() {
        ...
        if (ajk_designation.trim() == "") {
            $("#ajk_designation_edit_error").html('<span style="color:red;font-style:italic;font-size:13px;">Sila pilih Jawatan</span>');
        ...
        function () {
            $.ajax({
                ...
                success: function (data) {
                    if (data.trim() == "true") {
                        $.notify({
                            message: '<p style="text-align: center; margin-bottom: 0px;">Dipadam</p>'
                        }, {
                            type: 'success',
                            placement: {
                                align: "center"
