                ...
                <div class="col-lg-12">
                    ...
                    <div id="update_files_lists">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active">Kawasan Pemajuan (STRATA)</a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <form id="strata">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Nama</label>
                                                        <input type="text" class="form-control" placeholder="Nama" id="strata_name" value="{{$strata->name}}" readonly="">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <label>Alamat</label>
                                                        <input type="text" class="form-control" placeholder="Alamat 1" id="strata_address1" value="{{$strata->address1}}" readonly="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" placeholder="Alamat 2" id="strata_address2" value="{{$strata->address2}}" readonly="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" placeholder="Alamat 3" id="strata_address3" value="{{$strata->address3}}" readonly="">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Poskod</label>
                                                        <input type="text" class="form-control" placeholder="Poskod" id="strata_poscode" value="{{$strata->poscode}}" readonly="">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Bilangan Blok" id="strata_block_no" value="{{$strata->block_no}}" readonly="">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="No. Hakmilik" id="strata_ownership_no" value="{{$strata->ownership_no}}" readonly="">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-inline">
                                                            <input type="text" class="form-control" placeholder="Luas Tanah" id="strata_land_area" value="{{$strata->land_area}}" readonly="">                               
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>No. Lot</label>
                                                        <input type="text" class="form-control" placeholder="No. Lot" id="strata_lot_no" value="{{$strata->lot_no}}" readonly="">   
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="input-group datepicker-only-init">
                                                            <input type="text" class="form-control" placeholder="Tarikh (VP)" id="strata_date" value="{{$strata->date}}" readonly="">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Bilangan Unit Kediaman" id="residential_unit_no" readonly="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-inline">
                                                                <input type="text" class="form-control" placeholder="Caj Selenggaran (RM)" id="residential_maintenance_fee" readonly="">                               
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-inline">
                                                                <input type="text" class="form-control" placeholder="Sinking Fund (RM)" id="residential_sinking_fund" readonly="">                              
                                            ...
                                            <div id="residential_form">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>Bilangan Unit Kediaman</label>
                                                            <input type="text" class="form-control" placeholder="Bilangan Unit Kediaman" id="residential_unit_no" value="{{$residential->unit_no}}" readonly="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Caj Selenggaran (RM)</label>
                                                            <div class="form-inline">
                                                                <input type="text" class="form-control" placeholder="Caj Selenggaran (RM)" id="residential_maintenance_fee" value="{{$residential->maintenance_fee}}" readonly="">                               
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Sinking Fund (RM)</label>
                                                            <div class="form-inline">
                                                                <input type="text" class="form-control" placeholder="Sinking Fund (RM)" id="residential_sinking_fund" value="{{$residential->sinking_fund}}" readonly="">                              
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Bilangan Unit Komersial" id="commercial_unit_no" readonly="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Caj Selenggaran (RM)</label>
                                                            <div class="form-inline">
                                                                <input type="text" class="form-control" placeholder="Caj Selenggaran (RM)" id="commercial_maintenance_fee" readonly="">                               
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Sinking Fund (RM)</label>
                                                            <div class="form-inline">
                                                                <input type="text" class="form-control" placeholder="Sinking Fund (RM)" id="commercial_sinking_fund" readonly="">                              
                                            ...
                                            <div id="commercial_form">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>Bilangan Unit Komersial</label>
                                                            <input type="text" class="form-control" placeholder="Bilangan Unit Komersial" id="commercial_unit_no" value="{{$commercial->unit_no}}" readonly="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Caj Selenggaran (RM)</label>
                                                            <div class="form-inline">
                                                                <input type="text" class="form-control" placeholder="Caj Selenggaran (RM)" id="commercial_maintenance_fee" value="{{$commercial->maintenance_fee}}" readonly="">                               
                                                                <select class="form-control" id="commercial_maintenance_fee_option" disabled="">
                                                                    @foreach ($unitoption as $unitoptions)
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Sinking Fund (RM)</label>
                                                            <div class="form-inline">
                                                                <input type="text" class="form-control" placeholder="Sinking Fund (RM)" id="commercial_sinking_fund" value="{{$commercial->sinking_fund}}" readonly="">                              
                                                                <select class="form-control" id="commercial_sinking_fund_option" disabled="">
                                                                    @foreach ($unitoption as $unitoptions)
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea class="form-control" rows="3" id="others" placeholder="Pelbagai" readonly="">{{$facility->others}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
