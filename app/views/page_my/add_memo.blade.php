                ...
                <div class="col-lg-12">
                    ...
                    <form id="add_memo">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <label class="input-group datepicker-only-init">
                                        <input type="text" class="form-control" placeholder="Tarikh Memo" id="memo_date" />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <label class="input-group datepicker-only-init">
                                        <input type="text" class="form-control" placeholder="Tarikh Papar" id="publish_date" />
                                        <span class="input-group-addon">
                                            <i class="icmn-calendar"></i>
                                        </span>
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <label class="input-group datepicker-only-init">
                                        <input type="text" class="form-control" placeholder="Tarikh Luput" id="expired_date" />
                                        <span class="input-group-addon">
                                            <i class="icmn-calendar"></i>
                                        </span>
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Subjek" id="subject">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addMemo()">Simpan</button>
                            <?php } ?>
        ...
        if (error == 0) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>Tambah memo berjaya!</span>", function () {
