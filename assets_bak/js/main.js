...
if ($(document).ready(function() {
        localStorage.getItem("fixedTop") && ($(".navbar-top").addClass("fixed"), $("#fixed-navbar").prop("checked", !0)), $("#fixed-navbar").click(function() {
            ...
            return e.is(":visible") ? e.addClass("hide").removeClass("show") : e.addClass("show").removeClass("hide"), !1
        ...
        function t(t, o) {
            this.element = t, this.settings = e.extend({}, a, o), this._defaults = a, this._name = n, this.init()
        }
        var n = "eKMenu",
            a = {
                toggle: !0
...
var App = function() {
        ...
        var n = function(n) {
                if ("webkitSpeechRecognition" in window)
                    ...
                    $.extend(a, n), a.continuous && (t.continuous = !0), a.interim && (t.interimResults = !0), a.lang && (t.lang = a.lang);
                    var o = !1,
                        i = "";
                    t.onresult = function(t) {
                        for (var n = t.resultIndex; n < t.results.length; ++n)
                            if (t.results[n].isFinal) {
                                ...
                                s = s.toLowerCase(), s = s.replace(/^\s+|\s+$/g, ""), console.log(s), a.onResult && a.onResult(s), $.each(e, function(e, t) {
